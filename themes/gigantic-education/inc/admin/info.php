...
if ( ! class_exists( 'Kortez_Construction_FSE_Theme_Info' ) ) {
    class Kortez_Construction_FSE_Theme_Info{
        ...
        public function __construct( $config ) {
            ...
            /* Admin menu */
            add_action( 'admin_menu', array( $this, 'gigantic_education_admin_menu' ) );
        ...
        public function prepare_class() {
            ...
            $this->page_title    = $this->theme_name . esc_html__( ' Info', 'gigantic-education' );
        }
        
        /**
         * Adding Theme Info Menu under Appearance.
         */
        function gigantic_education_admin_menu() {
            if ( ! empty( $this->page_title ) ) {
                add_theme_page( $this->page_title, esc_html__( 'Upgrade to Pro', 'gigantic-education' ), 'edit_theme_options', $this->theme_slug . '-info', array(
                    $this,
                    'gigantic_education_theme_info_screen',
                ) );
            }
        }
         ...
         */
        public function gigantic_education_theme_info_screen() {
            ...
            if (
                ...
                echo '<a href="' . esc_url( 'https://kortezthemes.com/gigantic-education-pro/' ).'" target="_blank">';
        ...
        public function style_and_scripts() {
            wp_enqueue_style( 'gigantic-education-theme-info-css', get_template_directory_uri() . '/inc/admin/info.css' );
...
$config = array(
    ...
    // Main welcome title
    'info_title' => sprintf( esc_html__( 'Welcome to %s - ', 'gigantic-education' ), $theme_name_config ),

    // Main welcome content
    'info_content' => sprintf( esc_html__( 'Gigantic Pro offers more features and enhances your experience!', 'gigantic-education' ), '<b>'.$theme_name_config.'</b>' ),
    ...
    'quick_links' => array(
        'theme_url'  => array(
            'text' => __( 'Buy Now', 'gigantic-education' ),
            'url' => 'https://kortezthemes.com/gigantic-pro/'
        )
    ),
);

return new Kortez_Construction_FSE_Theme_Info( $config );
});