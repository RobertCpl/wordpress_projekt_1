<?php
 /**
  * Title: Template 404
  * Slug: gigantic-education/template-404
  * Categories: template
  * Inserter: false
  */
?>
...
<p class="has-text-align-center"><?php echo esc_html__( 'This page could not be found. Maybe try a search?', 'gigantic-education' ); ?></p>
<!-- /wp:paragraph -->
